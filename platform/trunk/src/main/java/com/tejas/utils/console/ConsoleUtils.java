...
public class ConsoleUtils
{
    ...
    {
        return "/" + ApplicationConfig.getApplicationName() + "/invoke/" + fqClassName;
    }
    ...
    public static void printTableWithLinks(PrintWriter out, String heading, List<String> columnNames, boolean centerAlignData, List<List<Object>> dataRows,
        ...
        else
        {
            ...
            for (List<Object> row : dataRows)
            {
                ...
                for (Object column : row)
                {
                    ...
                    {
                        out.println("<td " + (centerAlignData ? "align='center'" : "") + "><a target='_blank' href=\"" + links.get(columnNamesArray[index]) + "?"
                                + columnNamesArray[index] + "=" + column + "\">" + column + "</a></td>");
                    }
                    else
                    {
                        out.println("<td " + (centerAlignData ? "align='center'" : "") + ">" + column + "</td>");
